...
void ft_isdigit_test(void)
{
    ...
    {
        total_tests++;
        int expected = 1;  // ft_isdigit should return 1 for digits
    ...
    {
        total_tests++;
        int expected = 0;  // ft_isdigit should return 0 for non-digits
    ...
    {
        total_tests++;
        int expected = 0;  // ft_isdigit should return 0 for extended ASCII
        int result = ft_isdigit(c);
        if (result != expected)
        {
    ...
    {
        total_tests++;
        int expected = 0;  // ft_isdigit should return 0 for negative values
        int result = ft_isdigit(c);
        if (result != expected)
        {
            printf("%s[FAIL]%s ft_isdigit(%d) = %d, expected %d\n", 
